...
public ref class MeatClass : public BaseCatagory
{
public:
    ...
    virtual void addd(System::String^% errorMessage) override
    {
        ...
        if (codeExists)
        {
            // Product code already exists, set the errorMessage
    ...
    virtual bool addtocart(int productCode, int quantity, System::String^% errorMessage) override
    {
        ...
        while (inputFile >> code >> n >> p >> d)
        {
            ...
            if (code == productCode)
            {
                ...
                cartFile << code << " " << n << " " << p << " " << d << " " << quantity << std::endl;
                cartFile.close();
                return true;
            }
        }
