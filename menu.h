...
#include "fruitMenu.h";
#include "vegetableMenu.h";
#include "dairyproductMenu.h";
namespace ayesha {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 28.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->ForeColor = System::Drawing::Color::White;
			this->label1->Location = System::Drawing::Point(984, 130);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(137, 50);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 40.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->ForeColor = System::Drawing::Color::Yellow;
			this->label2->Location = System::Drawing::Point(887, 190);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(321, 71);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Catagories";
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(142, 359);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(167, 69);
			...
			this->pictureBox1->Location = System::Drawing::Point(32, 402);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(404, 333);
			...
			this->label4->Location = System::Drawing::Point(593, 359);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(186, 69);
			this->label4->TabIndex = 4;
			this->label4->Text = L"Fruits";
			// 
			// pictureBox2
			// 
			...
			this->pictureBox2->Location = System::Drawing::Point(483, 402);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(404, 333);
			...
			this->label5->Location = System::Drawing::Point(969, 359);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(338, 69);
			this->label5->TabIndex = 6;
			this->label5->Text = L"Vegetables";
			// 
			// pictureBox3
			// 
			...
			this->pictureBox3->Location = System::Drawing::Point(935, 402);
			this->pictureBox3->Name = L"pictureBox3";
			this->pictureBox3->Size = System::Drawing::Size(404, 333);
			...
			this->label6->Location = System::Drawing::Point(1428, 359);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(435, 69);
			this->label6->TabIndex = 8;
			this->label6->Text = L"Dairy Products";
			// 
			// pictureBox4
			// 
			...
			this->pictureBox4->Location = System::Drawing::Point(1326, 399);
			this->pictureBox4->Name = L"pictureBox4";
			this->pictureBox4->Size = System::Drawing::Size(479, 333);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(154, 791);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(605, 791);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(1066, 791);
			...
			this->button4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button4->Location = System::Drawing::Point(1536, 791);
			...
			this->ClientSize = System::Drawing::Size(1882, 1055);
